...
export default function Home() {
  return (
    <>
      {" "}
      <MaxWidthWrapper className="my-12 sm:mt-25 flex flex-col items-center justify-center text-center">
        ...
        <div className="my-5 max-w-prose text-zinc-700 sm:text-lg">
          Ask your PDF allows you to have conversations with any PDF document.
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        ...
        <ol className="m-4  space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
